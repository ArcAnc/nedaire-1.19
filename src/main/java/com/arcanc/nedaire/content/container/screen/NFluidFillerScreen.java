...
public class NFluidFillerScreen extends NContainerScreen<NFluidFillerMenu> 
{

	public NFluidFillerScreen(NFluidFillerMenu slots, Inventory player, Component title) 
	{
