...
public abstract class ModAbstractToolMaterial implements Tier 
{
	...
	public ModAbstractToolMaterial(ModAbstractToolMaterial.ToolAbstractBuilder<?> builder) 
	{
	...
	public abstract static class ToolAbstractBuilder<T extends ToolAbstractBuilder<T>>
	{
		...
		public abstract ModAbstractToolMaterial build(); 
	}
}
