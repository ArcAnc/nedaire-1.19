...
public abstract class ModAbstractPlayerArmorMaterial implements ArmorMaterial	 
{
	...
	protected ModAbstractPlayerArmorMaterial(ModAbstractPlayerArmorMaterial.PlayerArmorAbstractBuilder<?> builder) 
	{
	...
	public abstract static class PlayerArmorAbstractBuilder<T extends PlayerArmorAbstractBuilder<T>>
	{
		...
		public abstract ModAbstractPlayerArmorMaterial build ();
	}
