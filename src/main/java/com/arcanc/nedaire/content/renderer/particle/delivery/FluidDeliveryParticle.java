...
public class FluidDeliveryParticle extends DeliveryParticle<FluidStack> 
{
	protected static final ResourceLocation TEXTURE_LOC = StringHelper.getLocFStr("misc/sphere");
	...
	public FluidDeliveryParticle(ClientLevel level, Vec3 startPos, Vec3 finishPos, Vec3 station, boolean toStation, FluidStack stack) 
	{
	...
	@Override
	protected FluidStack getContent() 
	{
		return stack;
	}
