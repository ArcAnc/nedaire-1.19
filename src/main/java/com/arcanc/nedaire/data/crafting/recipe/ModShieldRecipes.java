...
public class ModShieldRecipes extends ShieldDecorationRecipe
{
	   
	public ModShieldRecipes(ResourceLocation location, CraftingBookCategory category)
	{
		super(location, category);
	}
	
	public ModShieldRecipes(ResourceLocation location) 
	{
