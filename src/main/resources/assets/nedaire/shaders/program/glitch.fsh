 ...
 *
 * Thanks Su5eD for reworking it and sorry for stealing it
 * Su5eD code available at: https://github.com/BuiltBrokenModding/MFFS_Classic/blob/dev/1.19.x/src/main/resources/assets/mffs/shaders/program/glitch_blit.fsh
 */
#version 150
